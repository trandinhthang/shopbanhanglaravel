	                    ...
	                    ?>
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize = none" row="5" class="form-control" name="product_desc" id="exampleInputPassword1" placeholder="Mô tả sản phẩm"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Thông tin sản phẩm</label>
                                    <textarea style="resize = none" row="5" class="form-control" name="product_content" id="exampleInputPassword1" placeholder="Thông tin sản phẩm"></textarea>
                                </div>
                                <div class="form-group">
